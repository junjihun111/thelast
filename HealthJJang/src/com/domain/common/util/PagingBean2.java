...
public class PagingBean2 {
	 ...
	 */
	private int itemsPerPage = Constants2.ITEMS_PER_PAGE2;
	/**
	 * Page Group 내 Page 수.  페이지 그룹에 들어갈 페이지 개수
	 */
	private int pagesPerPagegroup = Constants2.PAGES_PER_PAGEGROUP2;
	 ...
	 * @param page 보려는 페이지.
	 */
	public PagingBean2(int totalItems, int page) {
		super();
	...
	public static void main(String[] args) {
		...
		//page내 게시물수 - 15
		//page그룹내 page수 - 10
		System.out.println("총 page 수 : "+d.getTotalPage()); //14
		System.out.println("총 page그룹 : "+d.getTotalPageGroup());//2
